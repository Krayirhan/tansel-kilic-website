...
Call log:
  ...
  - waiting for locator('a[href="#about"]').first()
    13 × locator resolved to <a href="#about" class="whitespace-nowrap text-[0.9rem] font-medium tracking-[0.01em] text-slate-500 transition-colors duration-200 hover:text-slate-900">Hakkımda</a>
...
- banner:
  ...
  - button "Menüyü aç veya kapat" [expanded]
  - navigation:
    - link "Hakkımda":
      - /url: "#about"
    - link "Deneyim":
