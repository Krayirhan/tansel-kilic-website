...
- main:
  ...
  - complementary: Stratejiden uygulamaya AI dönüşümü Fintech platformları Mühendislik ölçeği
  - region "Etki":
  ...
  - article:
    ...
    - paragraph: Kullanıcı deneyimi odaklı yenilikçi toplantı platformu Huudle'ın geliştirilmesini yönetti. Mühendis işe alımı, ekip yönetimi, sistem mimarisi ve veri gizliliği standartlarına uyum.
    - text: Startup GCP Sistem Mimarisi
  - article:
    - heading "Yazılım Mühendisliği Direktörü" [level=3]
    - text: Şub 2022 — Şub 2023 · 1 yıl 1 ay · Londra, İngiltere Pisano — London
    - paragraph: IT yol haritası, bütçesi ve strateji sorumluluğu. Geliştirme, DevOps, QA, Entegrasyon, PO ve BA ekiplerini yönetti. Mühendislik ekibini 1 yılda 3 katına çıkardı. Microsoft, Salesforce ve Azure Marketplace ortaklıkları geliştirdi.
    - text: Azure Salesforce Ekip Büyütme
  - article:
    - heading "Yazılım Mühendisliği Direktörü" [level=3]
    - text: Tem 2021 — Şub 2022 · 8 ay Demirören Teknoloji / Azerloterya — İstanbul
    - paragraph: Azerbaycan Spor Bahis ve Sanal Spor platformları ve mobil uygulamaları. Azure üzerinde 100+ mikroservis. 30-35 kişilik mühendislik ekibi yönetimi (Scrum/Kanban). Azure DevOps ve üçüncü taraf entegrasyonlar.
    - text: Azure Mikroservisler DevOps
  ...
  - article:
    ...
    - paragraph: POS, Sanal POS, dijital cüzdan, AML ve finansal uyumluluk tarafında güçlü uygulama deneyimi.
  - text: Sistemler
  - article:
  ...
  - article:
    ...
    - paragraph: HSM entegrasyonları, mTLS, PKI ve kurumsal güvenlik mimarisi deneyimi.
  - text: Liderlik
  - article:
  ...
  - article:
    ...
    - paragraph: Eski sistemleri modern ve ölçeklenebilir dijital platformlara dönüştürme deneyimi.
  ...
  - paragraph: Kritik kararlarda insan denetimi varsayılandır. Otomasyon, güven arttıkça kademeli genişler.
  - heading "Gizlilik tasarımı" [level=3]
  - paragraph: Finansal ve hassas veriler için on-premise mimari kurulur. Veri sınır dışına çıkmaz; uyumluluk mimaride çözülür.
  - text: Ozan · 2024–2025
  ...
  - paragraph: İşlem verileri ve metinsel sinyalleri NLP ve LLM ile analiz eden fraud tespit sistemi. Kural tabanlı yaklaşımın ötesinde şüpheli desenleri gerçek zamanlı tespit eder; fintech, e-ticaret ve telekom için ölçeklenebilir yapıdadır.
